...
import 'package:my_insta/model/user_model.dart';
import 'package:my_insta/pages/sign_in_page.dart';
import 'package:my_insta/services/auth_service.dart';
import 'package:my_insta/services/data_service.dart';
import 'package:my_insta/services/hive_service.dart';
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void _doSignUp() async {
    ...
    if (email.isEmpty || password.isEmpty || name.isEmpty) {
      Utils.showSnackBar('Fields cannot be null or empty', context);
      return;
    }
    if (password != cpassword) {
      Utils.showSnackBar('Password and Confirm password do not match', context);
      return;
    }
    setState(() {
      isLoading = true;
