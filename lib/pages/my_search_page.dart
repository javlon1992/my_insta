...
import 'package:my_insta/services/http_service.dart';
...
class _MySearchPageState extends State<MySearchPage> {
  ...
  void _apiFollowUser(UserModel someone) async {
    ...
    await Network.POST(Network.API_PUSH, Network.bodyCreate(someone.device_token)).then((value) {
      print(value);
    });
    ...
    return ListTile(
      ...
      leading: Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                width: 1.5, color: const Color.fromRGBO(245, 96, 64, 1))),
        child: ClipRRect(
